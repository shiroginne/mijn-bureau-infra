...
```console
helm install my-release oci://registry-1.docker.io/bitnamicharts/livekit_server
```

Looking to use livekit_server in production? Try [VMware Tanzu Application Catalog](https://bitnami.com/enterprise), the commercial edition of the Bitnami catalog.
...
```console
helm install my-release oci://REGISTRY_NAME/REPOSITORY_NAME/livekit_server
```
